...
function sendEmail($to, $subject, $body, $attachment = null) {
    ...
    // Do NOT provide real credentials as hard-coded defaults. Leave blank so env must supply them.
...
function smtp_direct_send($to, $subject, $body, $host = null, $user = null, $pass = null, $port = null) {
    ...
    // Port 587 (TLS) usually starts with EHLO and then STARTTLS
    $is_ssl = ($port == 465);
    $is_tls = ($port == 587);
